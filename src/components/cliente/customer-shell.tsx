...
const navigation: NavItem[] = [
  ...
  {
    label: "Prêmios",
    href: "/cliente/premios",
    icon: Gift,
  },
  {
    label: "Resgates",
    href: "/cliente/resgates",
    icon: Ticket,
  },
  {
    label: "Configurações",
...
function getPageTitle(pathname: string) {
  ...
  if (pathname.startsWith("/cliente/historico")) return "Historico";
  if (pathname.startsWith("/cliente/compras")) return "Compras";
  if (pathname.startsWith("/cliente/premios")) return "Prêmios";
  if (pathname.startsWith("/cliente/resgates")) return "Resgates";
  if (pathname.startsWith("/cliente/perfil")) return "Perfil";
  if (pathname.startsWith("/cliente/configuracoes")) return "Configurações";
  return "Painel";
}

function isActivePath(itemHref: string, pathname: string) {
  if (itemHref === "/cliente") return pathname === itemHref;
      ...
      <div className="flex h-16 items-center border-b border-zinc-200 px-4">
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-zinc-500">Área do cliente</p>
          </div>
        </Link>
      </div>
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-[280px_1fr]">
        ...
        <div className="flex min-h-screen flex-col">
          ...
          <main className="flex-1 px-4 py-5 pb-24 sm:px-6 sm:py-6 sm:pb-24 lg:pb-6">
            <div className="rounded-3xl border border-white/40 bg-white/60 p-0 backdrop-blur-sm">
              {children}
            </div>
          </main>
        </div>
